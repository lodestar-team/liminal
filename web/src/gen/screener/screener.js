...
const _trampoline12 = function(arg0, arg1, arg2) {
  ...
  _debugLog('[iface="liminal:node/store@0.2.0", function="get"] [Instruction::CallInterface] (sync, @ enter)');
  let hostProvided = true;
  ...
  _debugLog('[iface="liminal:node/store@0.2.0", function="get"][Instruction::Return]', {
    funcName: 'get',
    paramCount: 0,
    async: false,
    postReturn: false
...
_trampoline12.fnName = 'liminal:node/store@0.2.0#get';
...
const _trampoline13 = function(arg0, arg1, arg2, arg3) {
  ...
  _debugLog('[iface="liminal:node/store@0.2.0", function="set"] [Instruction::CallInterface] (sync, @ enter)');
  let hostProvided = true;
  ...
  _debugLog('[iface="liminal:node/store@0.2.0", function="set"][Instruction::Return]', {
    funcName: 'set',
    paramCount: 0,
    async: false,
    postReturn: false
...
_trampoline13.fnName = 'liminal:node/store@0.2.0#set';
...
_trampoline14.fnName = 'wasi:io/streams@0.2.6#checkWrite';
...
_trampoline15.fnName = 'wasi:io/streams@0.2.6#write';
...
_trampoline16.fnName = 'wasi:io/streams@0.2.6#blockingFlush';
...
_trampoline17.fnName = 'wasi:cli/environment@0.2.6#getEnvironment';
...
_trampoline18.fnName = 'wasi:cli/terminal-stdin@0.2.6#getTerminalStdin';
...
_trampoline19.fnName = 'wasi:cli/terminal-stdout@0.2.6#getTerminalStdout';
...
_trampoline20.fnName = 'wasi:cli/terminal-stderr@0.2.6#getTerminalStderr';
let exports2;
let postReturn0;
let postReturn0Async;
let node020Transform;

function transform(arg0) {
  var val0 = arg0;
  ...
  _debugLog('[iface="liminal:node/node@0.2.0", function="transform"][Instruction::CallWasm] enter', {
    funcName: 'transform',
    paramCount: 2,
    async: false,
    postReturn: true,
  ...
  _debugLog('[iface="liminal:node/node@0.2.0", function="transform"][Instruction::Return]', {
    funcName: 'transform',
    paramCount: 1,
    async: false,
    postReturn: true
...
const $init = (() => {
  let gen = (function* _initGenerator () {
    const module0 = fetchCompile(new URL('./screener.core.wasm', import.meta.url));
    const module1 = base64Compile('');
    const module2 = base64Compile('AGFzbQEAAAABHgVgA39/fwBgBH9/f38AYAJ/fwBgBH9/f38AYAF/AAI9CgABMAAAAAExAAEAATIAAgABMwADAAE0AAIAATUABAABNgAEAAE3AAQAATgABAAIJGltcG9ydHMBcAEJCQkPAQBBAAsJAAECAwQFBgcIAC8JcHJvZHVjZXJzAQxwcm9jZXNzZWQtYnkBDXdpdC1jb21wb25lbnQHMC4yNDMuMA');
    ({ exports: exports0 } = yield instantiateCore(yield module1));
    ({ exports: exports1 } = yield instantiateCore(yield module0, {
      'liminal:node/store@0.2.0': {
        get: exports0['0'],
        set: exports0['1'],
      },
    ...
    postReturn0 = exports1['cabi_post_liminal:node/node@0.2.0#transform'];
    
    try {
      postReturn0Async = WebAssembly.promising(exports1['cabi_post_liminal:node/node@0.2.0#transform']);
    } catch(err) {
      postReturn0Async = exports1['cabi_post_liminal:node/node@0.2.0#transform'];
    }
    
    node020Transform = exports1['liminal:node/node@0.2.0#transform'];
  })();
...
export { node020 as node, node020 as 'liminal:node/node@0.2.0',  }