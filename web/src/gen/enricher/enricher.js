...
_trampoline12.fnName = 'wasi:io/streams@0.2.6#checkWrite';
...
_trampoline13.fnName = 'wasi:io/streams@0.2.6#write';
...
_trampoline14.fnName = 'wasi:io/streams@0.2.6#blockingFlush';
...
_trampoline15.fnName = 'wasi:cli/environment@0.2.6#getEnvironment';
...
_trampoline16.fnName = 'wasi:cli/terminal-stdin@0.2.6#getTerminalStdin';
...
_trampoline17.fnName = 'wasi:cli/terminal-stdout@0.2.6#getTerminalStdout';
...
_trampoline18.fnName = 'wasi:cli/terminal-stderr@0.2.6#getTerminalStderr';
let exports2;
let postReturn0;
...
const $init = (() => {
  let gen = (function* _initGenerator () {
    const module0 = fetchCompile(new URL('./enricher.core.wasm', import.meta.url));
    const module1 = base64Compile('');
    const module2 = base64Compile('AGFzbQEAAAABEQNgAn9/AGAEf39/fwBgAX8AAjMIAAEwAAAAATEAAQABMgAAAAEzAAIAATQAAgABNQACAAE2AAIACCRpbXBvcnRzAXABBwcJDQEAQQALBwABAgMEBQYALwlwcm9kdWNlcnMBDHByb2Nlc3NlZC1ieQENd2l0LWNvbXBvbmVudAcwLjI0My4w');
    ...
    ({ exports: exports1 } = yield instantiateCore(yield module0, {
      ...
      'wasi:cli/terminal-stderr@0.2.0': {
        'get-terminal-stderr': exports0['6'],
      },
      'wasi:cli/terminal-stdin@0.2.0': {
        'get-terminal-stdin': exports0['4'],
      },
      'wasi:cli/terminal-stdout@0.2.0': {
        'get-terminal-stdout': exports0['5'],
      },
      'wasi:io/error@0.2.0': {
      ...
      'wasi:io/streams@0.2.0': {
        '[method]output-stream.blocking-flush': exports0['2'],
        '[method]output-stream.check-write': exports0['0'],
        '[method]output-stream.subscribe': trampoline8,
        '[method]output-stream.write': exports0['1'],
